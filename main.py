...
async def server_side_rendered_blog(slug: str):
    ...
    <div class="w-full flex justify-center my-4 min-h-[50px] overflow-hidden">
        <script>
          atOptions = { 'key' : '556894ab6258448a0e6a40e709cacdc5', 'format' : 'iframe', 'height' : 50, 'width' : 320, 'params' : {} };
        </script>
        <script type="text/javascript" src="https://www.highperformanceformat.com/556894ab6258448a0e6a40e709cacdc5/invoke.js"></script>
    </div>
    """
    html = html.replace(
    ...
    ad_after_p1 = BeautifulSoup("""<div class="w-full flex justify-center my-6 min-h-[250px] overflow-hidden"><script type="text/javascript">atOptions = { 'key' : '5cb5c1e8dfe4da83170e1b1982c9293b', 'format' : 'iframe', 'height' : 250, 'width' : 300, 'params' : {} };</script><script type="text/javascript" src="https://www.highperformanceformat.com/5cb5c1e8dfe4da83170e1b1982c9293b/invoke.js"></script></div>""", "html.parser")
    ad_mid = BeautifulSoup("""<div class="w-full flex justify-center my-6 min-h-[60px] overflow-hidden"><script type="text/javascript">atOptions = { 'key' : '969752f4dee8e05427cf25dde238cc40', 'format' : 'iframe', 'height' : 60, 'width' : 468, 'params' : {} };</script><script type="text/javascript" src="https://www.highperformanceformat.com/969752f4dee8e05427cf25dde238cc40/invoke.js"></script></div>""", "html.parser")
    ad_last_img = BeautifulSoup("""<div class="w-full flex justify-center my-6 min-h-[90px] overflow-hidden"><script type="text/javascript">atOptions = { 'key' : 'cdc306a38190dff969b12ccb0f570436', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {} };</script><script type="text/javascript" src="https://www.highperformanceformat.com/cdc306a38190dff969b12ccb0f570436/invoke.js"></script></div>""", "html.parser")
