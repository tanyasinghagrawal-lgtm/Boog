...
async def server_side_rendered_blog(slug: str):
    ...
    # 300x250 (Usually fits both screens, gap increased)
    ad_after_p1 = BeautifulSoup("""<div class="w-full flex justify-center my-10 min-h-[250px] overflow-hidden">
        <script type="text/javascript">atOptions = {'key': '5cb5c1e8dfe4da83170e1b1982c9293b', 'format': 'iframe', 'height': 250, 'width': 300, 'params': {}};</script>
        <script type="text/javascript" src="//www.highperformanceformat.com/5cb5c1e8dfe4da83170e1b1982c9293b/invoke.js"></script>
    </div>""", "html.parser")
    
    # 468x60 (Desktop) | 320x50 (Mobile)
    ad_mid = BeautifulSoup("""<div class="w-full my-10 overflow-hidden text-center">
        <div class="ad-desktop min-h-[60px] flex justify-center w-full">
            <script type="text/javascript">atOptions = {'key': '969752f4dee8e05427cf25dde238cc40', 'format': 'iframe', 'height': 60, 'width': 468, 'params': {}};</script>
            <script type="text/javascript" src="//www.highperformanceformat.com/969752f4dee8e05427cf25dde238cc40/invoke.js"></script>
        </div>
        <div class="ad-mobile min-h-[50px] flex justify-center w-full">
            <script type="text/javascript">atOptions = {'key': '556894ab6258448a0e6a40e709cacdc5', 'format': 'iframe', 'height': 50, 'width': 320, 'params': {}};</script>
            <script type="text/javascript" src="//www.highperformanceformat.com/556894ab6258448a0e6a40e709cacdc5/invoke.js"></script>
        </div>
    </div>""", "html.parser")
    
    # 728x90 (Desktop) | 320x50 (Mobile)
    ad_last_img = BeautifulSoup("""<div class="w-full my-10 overflow-hidden text-center">
        <div class="ad-desktop min-h-[90px] flex justify-center w-full">
            <script type="text/javascript">atOptions = {'key': 'cdc306a38190dff969b12ccb0f570436', 'format': 'iframe', 'height': 90, 'width': 728, 'params': {}};</script>
            <script type="text/javascript" src="//www.highperformanceformat.com/cdc306a38190dff969b12ccb0f570436/invoke.js"></script>
        </div>
        <div class="ad-mobile min-h-[50px] flex justify-center w-full">
            <script type="text/javascript">atOptions = {'key': '556894ab6258448a0e6a40e709cacdc5', 'format': 'iframe', 'height': 50, 'width': 320, 'params': {}};</script>
            <script type="text/javascript" src="//www.highperformanceformat.com/556894ab6258448a0e6a40e709cacdc5/invoke.js"></script>
    ...
    <aside class="desktop-side-ads ad-left-panel">
        <div class="overflow-hidden rounded-lg shadow-sm min-h-[300px] w-[160px] flex justify-center bg-white">
            <script type="text/javascript">atOptions = {'key': 'c80a57be6524c82a654f8d57c90d059d', 'format': 'iframe', 'height': 300, 'width': 160, 'params': {}};</script>
            <script type="text/javascript" src="//www.highperformanceformat.com/c80a57be6524c82a654f8d57c90d059d/invoke.js"></script>
        </div>
        <div class="overflow-hidden rounded-lg shadow-sm min-h-[300px] w-[160px] flex justify-center bg-white mt-4">
            <script type="text/javascript">atOptions = {'key': 'c80a57be6524c82a654f8d57c90d059d', 'format': 'iframe', 'height': 300, 'width': 160, 'params': {}};</script>
            <script type="text/javascript" src="//www.highperformanceformat.com/c80a57be6524c82a654f8d57c90d059d/invoke.js"></script>
        </div>
    </aside>
    ...
    <aside class="desktop-side-ads ad-right-panel">
        <div class="overflow-hidden rounded-lg shadow-sm min-h-[600px] w-[160px] flex justify-center bg-white">
            <script type="text/javascript">atOptions = {'key': '6e9568e69fe563ba0ac89d84035e022e', 'format': 'iframe', 'height': 600, 'width': 160, 'params': {}};</script>
            <script type="text/javascript" src="//www.highperformanceformat.com/6e9568e69fe563ba0ac89d84035e022e/invoke.js"></script>
        </div>
    </aside>
    """
    ...
    <div id="sticky-notif-ad">
        <div class="notif-inner">
            ...
            <div id="notifAdContent" style="width: 320px; height: 50px; background: #f3f4f6; border-radius: 4px; overflow: hidden; display: flex; justify-content: center; align-items: center;">
                <script type="text/javascript">atOptions = {'key': '556894ab6258448a0e6a40e709cacdc5', 'format': 'iframe', 'height': 50, 'width': 320, 'params': {}};</script>
                <script type="text/javascript" src="//www.highperformanceformat.com/556894ab6258448a0e6a40e709cacdc5/invoke.js"></script>
            </div>
        </div>
    ...
    <script>
        setTimeout(function() {
            ...
            function showNotif() {
                ...
                adBox.classList.add('show-notif'); 
            ...
            function hideNotif() {
                adBox.classList.remove('show-notif');
            }

            // User cut button dabaye toh chhup jaye
            closeBtn.addEventListener('click', hideNotif);

            // Har 20 seconds ka Auto-Cycle (Ad native rahega, bas UI pe slide in/out hoga, isse ad block nahi hoga)
            setInterval(() => {
                hideNotif(); 
