...
async def serve_service_worker():
    ...
    elif os.path.exists("firebase-messaging-sw.js"):
        return FileResponse("firebase-messaging-sw.js", media_type="application/javascript")
    return Response(status_code=404)
...
async def server_side_rendered_blog(slug: str):
    ...
    """
    # RichAds Verification Scripts Injection (Push, Pops, In-page)
    richads_scripts = """
    <script type="module" src="https://richinfo.co/richpartners/push/js/rp-cl-ob.js?pubid=1008688&siteid=394334&niche=33" async data-cfasync="false"></script>
    <script src="https://richinfo.co/richpartners/pops/js/richads-pu-ob.js" data-pubid="1008688" data-siteid="394335" async data-cfasync="false"></script>
    <script src="https://richinfo.co/richpartners/in-page/js/richads-ob.js?pubid=1008688&siteid=394337" async></script>
    """
