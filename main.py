...
async def server_side_rendered_blog(slug: str):
    ...
    """
    # RichAds Verification Script Injection
    richads_script = '<script src="https://richinfo.co/richpartners/in-page/js/richads-ob.js?pubid=1008688&siteid=394307" async></script>'
