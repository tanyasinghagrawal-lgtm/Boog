...
async def server_side_rendered_blog(slug: str):
    ...
    if rec_html_block:
        ...
        <style>
            ...
            .author-btn { display: inline-flex; align-items: center; justify-content: center; gap: 0.4rem; padding: 0.5rem 1.2rem; border-radius: 50px; font-weight: 700; font-size: 0.85rem; text-decoration: none; transition: all 0.3s ease; flex: 1; text-align: center; }
            .author-btn-in { background: #e0f2fe; color: #0284c7; border: 1px solid #bae6fd; }
            .author-btn-in:hover { background: #0284c7; color: #fff; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(2, 132, 199, 0.2); }
            .author-btn-mail { background: #fee2e2; color: #dc2626; border: 1px solid #fecaca; }
            .author-btn-mail:hover { background: #dc2626; color: #fff; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(220, 38, 38, 0.2); }
            @media (max-width: 640px) {
                ...
                .author-name, .author-loc { justify-content: center; }
            }
        </style>
        <aside class="author-card-wrapper" aria-label="About the Author">
            <div class="author-img-box">
                <img src="https://pranavblog.online/favicon.ico" alt="Pranav Sinha" onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=Pranav+Sinha&background=10b981&color=fff&size=150';">
            </div>
