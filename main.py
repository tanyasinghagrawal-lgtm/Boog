...
GEMINI_CHAT_KEY = "AIzaSyCsInmfsQ2mmTj_aonuKP8bgsd0IX7VFTo"
...
Be attractive in your formatting (use bullet points, bold text). Do NOT write very long responses. Keep it concise, energetic, and to the point.
If they ask something unrelated to the article, politely bring them back to the topic.

Article Title: {article['title']}
Article Content: {clean_text[:15000]} # Limit to save tokens
"""
    ...
    url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite:streamGenerateContent?alt=sse&key={GEMINI_CHAT_KEY}"
    ...
    async def event_generator():
        ...
        try:
            ...
            # Save to DB if it was a fixed prompt
            ...
            yield f"data: {json.dumps({'chunk': 'Sorry, I faced a glitch reading this context. Try again!'})}\n\n"
