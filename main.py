...
async def server_side_rendered_blog(slug: str):
    ...
    <style>
        ...
        /* 3. Featured Image Fix (No gray borders, natural height) */
        #featuredImageContainer { height: auto !important; background: transparent !important; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem; }
        #featuredImage { width: 100%; height: auto; max-height: 480px; object-fit: contain !important; border-radius: 0.75rem; }
        ...
        /* 5. Force Native Ad to be Horizontal (1 line) on Mobile */
        #container-e28003b4ef5b66a3c0d8a5adc5383190 { 
            display: flex !important; flex-direction: row !important; flex-wrap: nowrap !important; 
            overflow-x: auto !important; gap: 12px; padding-bottom: 8px; -webkit-overflow-scrolling: touch;
        }
        #container-e28003b4ef5b66a3c0d8a5adc5383190 > * { 
            flex: 0 0 calc(85% - 12px) !important; max-width: 280px !important; 
        }
        @media (min-width: 640px) {
            #container-e28003b4ef5b66a3c0d8a5adc5383190 > * { flex: 0 0 calc(25% - 12px) !important; }
        }
    </style>
    """
    ...
    # Title Ke Neeche Wala Ad (Iframe Lazy Load to prevent hanging)
    ad_under_title = """
    <div class="w-full flex justify-center my-4 min-h-[50px] overflow-hidden">
    ...
    if rec_html_block:
        ...
        # Inject Author Card AND Native Ad right before Recommendations Section
        html = html.replace(
    ...
    """
    html = html.replace('</body>', analytics_and_ads_js)
